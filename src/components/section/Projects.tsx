...
export const projectList: Project[] = [
  ...
  },
  {
    ...
    description:
      "Web application project that displays PM 2.5 data and graph of PM 2.5 value of a period of time from the sensor (esp8266 and Xiaomi Air Purifier) around SIT, Lx and CB2 Building in SIT KMUTT area.",
    type: "Website",
    status: "website",
    cover: pm1,
  ...
  },
  {
    ...
    title: "Cluo Biz",
    description:
      "Redesign of IA/POS system for staff and cashier use in laundry shop that allows user to manage the system.",
    type: "UX/UI",
    status: "inProgress",
    role: "UX/UI Designer",
    cover: image,
  ...
  },
  {
    ...
    description:
      "Web appplication for teaching student who study in this activities to learn how to create and use Backend server properly using Node.js + ExpressJS which I'm teaching Backend and Database in this activities.",
    type: "Website",
    status: "github",
    role: "Full Stack Developer + UI/UX Designer + Database Designer",
    cover: image,
  ...
  },
  {
    ...
    description:
      "Web application made in 36 hour hackathon that allows users to find travel information inside Thailand with clever suggestion and recommendation system by using longitude, latitude and user preferences for being part of recommendation features and allow register user favorite their places.",
    type: "Website",
    status: "inProgress",
    role: "Full Stack Developer + UI/UX Designer + Database Designer",
    cover: image,
...
export default function Projects() {
  ...
  const categorizedType = projectList.map((project: Project, index: number) => {
    return project.type;
  })
    ...
    <section id="project">
      ...
      <Collapsible open={isOpen} onOpenChange={setIsOpen} className="w-full">
        <div className="flex flex-wrap justify-center md:justify-between">
          {(() => {
            const filtered = projectList.filter((project) => project.type === selectedType || selectedType === "all").slice(0, 3);
        ...
        <CollapsibleContent className="flex flex-wrap justify-center md:justify-between gap-y-3">
          {(() => {
          ...
          <CollapsibleTrigger className="flex items-center gap-2 text-[14px] text-gray hover:text-white transition-all duration-300">
            {isOpen ? (
              <div className="flex items-center align-middle justify-center gap-2">
                <h1>see less</h1> <FaAngleUp />
              </div>
            ) : (
              <div className="flex items-center align-middle justify-center gap-2">
                <h1>see more</h1> <FaAngleDown />
              </div>
            )}
          </CollapsibleTrigger>
        </div>
